                            ...
                            <form class="layui-form">
                                <table class="layui-table">
                                        ...
                                        if (stu_list.isEmpty() || stu_list.size() == 0 ){
                                        	%>
                                        	<tr>
	                                            <td colspan="6" style="text-align: center;">暂无注册教师</td>
	                                          </tr>
                                        	<%
                                        }else{
                                        	for(int i = 0 ; i < stu_list.size() ; i++){
                                        		...
                                        		<tr>
		                                            ...
		                                            <td><%=map.get("name") %></td>
		                                            <td><%=map.get("tel") %></td>
		                                            <td><input type="checkbox" lay-skin="switch" lay-filter="switchTest" data-type="<%=map.get("id") %>" lay-text="允许|禁止" <%=(int)map.get("flag")==1?"checked":"" %>></td>
        ...
        layui.use(['element' , 'form' , 'layer'], function(){
            ...
            form.on('switch(switchTest)', function(data){
                $.ajax({
                    ...
                    dataType:'json',
                    data:{id:$(this).data('type'),flag:this.checked ? '1' : '4'},
